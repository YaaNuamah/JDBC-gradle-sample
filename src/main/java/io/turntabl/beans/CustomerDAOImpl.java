...
public class CustomerDAOImpl implements CustomerDAOImpl.CustomerDAO {


    RowMapper rowmapper = BeanPropertyRowMapper.newInstance(CustomerTO.class);
    List<CustomerTo> products = tmpl.queryForObject("select * from customers",rowMapper)
...
//    }
    ...
    public static interface CustomerDAO {
        public;
    }
}
